...
@interface SVWebViewController1 () <UIWebViewDelegate>
...
@implementation SVWebViewController1
...
- (void) receiveTestNotification:(NSNotification *) notification
{
    ...
    if ([[notification name] isEqualToString:@"TestNotification"]){
        ...
        //@"http://mkl-import.com/products/"
      //  [self.webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://mkl-import.com/products/"]]];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.navigationController.navigationBarHidden = YES;
	 [self loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://mkl-import.com/products/"]]];
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error {
    ...
    [self updateToolbarItems];
    UIAlertView * alert = [[UIAlertView alloc] initWithTitle:@"Error" message:@"Some Error Occured, Please check the internet connection." delegate:self cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
    [alert show];
